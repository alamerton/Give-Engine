...
describe("Test Charities API Express Server", () => {
    test("the '/' endpoint with a GET request", () => __awaiter(void 0, void 0, void 0, function* () {
        // arrange
    ...
    test("the '/:id' endpoint with a GET request containing a charity id", () => __awaiter(void 0, void 0, void 0, function* () {
        // arrange
        const id = 1000671;
        ...
        // act
        const res = yield (0, supertest_1.default)(server_1.default).get(`/${id}`);
        // assert
        expect(res.body).toEqual(expect.objectContaining({
            charity: expectedCharity,
        }));
    }));
    test("the '/:id' endpoint with a GET request containing a charity id that is not present in the database", () => __awaiter(void 0, void 0, void 0, function* () {
        // arrange
        const id = 1000000;
        const expectedError = {
            error: {},
...
describe("Test Likes API Express Server", () => {
    test("the '/' endpoint with a POST request to add a new like", () => __awaiter(void 0, void 0, void 0, function* () {
        // arrange
        const like = {
            id: "1",
            userId: "2",
        ...
        // act
        const response = yield (0, supertest_1.default)(server_1.default).post("/").send(like);
        // assert
        expect(response.status).toEqual(expectedStatusCode);
    }));
    test("the '/getLikeByUserId' endpoint with a POST request containing an existing user id", () => __awaiter(void 0, void 0, void 0, function* () {
        // arrange
    ...
    test("the '/getLikeByUserId' endpoint with a POST request containing an unknown user id", () => __awaiter(void 0, void 0, void 0, function* () {
        // arrange
...
describe("Test the Users API Express Server", () => {
    test("the '/' endpoint with a GET request to get all users", () => __awaiter(void 0, void 0, void 0, function* () {
        // arrange
    ...
    test("the '/create' endpoint with a POST request", () => __awaiter(void 0, void 0, void 0, function* () {
        // arrange
        const requestObject = {
        ...
        // act
        const response = yield (0, supertest_1.default)(server_1.default).post("/create").send(requestObject);
        // assert
        expect(response.status).toEqual(expectedStatus);
    }));
});
